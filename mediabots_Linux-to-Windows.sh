...
if [ $link1_status = "200" ] ; then 
	sudo wget -O /mediabots/WS2019R2.ISO https://archive.org/download/en-us_windows_server_2019_x64_dvd_f9475476/en-us_windows_server_2019_x64_dvd_f9475476.iso 
elif [ $link2_status = "200" -o $link2_status = "301" -o $link2_status = "302" ] ; then 
	sudo wget -P /mediabots https://archive.org/download/en-us_windows_server_2019_x64_dvd_f9475476/en-us_windows_server_2019_x64_dvd_f9475476.iso
else
